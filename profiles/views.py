...
class EditProfileWizard(SessionWizardView):
    ...
    def get_form_instance(self, step):
        ...
        # FOR SOME REASON THIS IS NOT WORKING PROPERLY, THIS WAS OVERCOMED
        # USING THE FUNCTION get_form_kwargs
        # if step == '1':
        #     return self.instance_dict.get(step,
        #                                   self.request.user.get_profile())
...
def edit_profile(request, form_class=None, success_url=None,
    ...
    **Template:**
    ...
    if request.method == 'POST':
        ...
        form = form_class(instance=profile_obj, user=request.user)
...
def profile_detail(request, username, public_profile_field=None,
    ...
    **Template:**
    ...
    try:
        ...
        raise Http404
    if public_profile_field is not None and not getattr(
            profile_obj, public_profile_field):
        profile_obj = None
